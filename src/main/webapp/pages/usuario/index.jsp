...
<html lang="pt-br">
<head>
	<%pageContext.setAttribute("pageTitle", "Perfil");%>
...
<body>
	<%pageContext.setAttribute("servletPath", "perfil");%>
	<%@ include file="../../components/header.jsp"%>
	<div id="cadastro-container"
		class="container-fluid w-100 bgc-purble-dark d-flex justify-content-center align-items-center">
		<div id="cadastro-container-content"
			...
			<h5 class="align-self-center">PERFIL</h5>
			<form action="<%=request.getContextPath()%>/perfil/editar" method="post">
				<fieldset>
					<div class="gap-2 d-grid">
						...
						<div class="row">
							<div class="col-12">
								<label for="email" class="form-label">E-mail</label> <input
									...
									value="${email}" name="email" placeholder="Digite seu e-mail" />
							</div>
						</div>
						<div class="row">
							<div class="col-md-3 col-sm-12">
								<label for="height" class="col-form-label">Altura</label> <input
									required type="number" class="form-control" id="height"
									step=0.1 value="${height}" name="height" placeholder="1,60" />
							</div>
							<div class="col-md-3 col-sm-12">
								<label for="weight" class="col-form-label">Peso</label> <input
									required type="number" class="form-control" id="weight"
									step=0.1 value="${weight}" name="weight" placeholder="90" />
							</div>
						...
						<div class="row">
							<div class="col-12">
								<label for="password" class="form-label">Senha</label> <input
									type="password" class="form-control" id="password" minlength=4
									value="${password}" name="password" placeholder="Digite sua senha" />
							</div>
						</div>
						<div class="row">
							<div class="col-12">
								<label for="confirm-password" class="form-label">Confirme
						...
						<div class="row mt-5">
							<div class="d-grid col-lg-6 col-md-8 col-sm-8 col-xs-12 mx-auto">
								<button type="submit" class="btn btn-md btn-primary bgc-primary">ATUALIZAR</button>
							</div>
						</div>
					</div>
				</fieldset>
